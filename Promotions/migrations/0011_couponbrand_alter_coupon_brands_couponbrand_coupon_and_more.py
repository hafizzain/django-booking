# Generated by Django 4.0.6 on 2023-12-25 02:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='coupon',
            name='brands',
            field=models.ManyToManyField(null=True, related_name='coupons_brand', through='Promotions.CouponBrand', to='Product.brand'),
        ),
        migrations.AddField(
            model_name='couponbrand',
            name='coupon',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Promotions.coupon'),
        ),
        migrations.CreateModel(
