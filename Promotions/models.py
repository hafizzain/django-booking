...
class Coupon(models.Model):
    ...
    buy_one_get_one_product = models.ManyToManyField(Product, related_name='coupons_product', null=True)
    buy_one_get_one_service = models.ManyToManyField(Service, related_name='coupons_service', null=True)
