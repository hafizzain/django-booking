...
from Promotions.models import DirectOrFlatDiscount , CategoryDiscount , DateRestrictions , DayRestrictions, BlockDate, PurchaseDiscount, ServiceGroupDiscount, SpecificBrand, SpecificGroupDiscount
