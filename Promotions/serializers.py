...
from Promotions.models import DirectOrFlatDiscount , CategoryDiscount , DateRestrictions , DayRestrictions, BlockDate, ServiceGroupDiscount, SpecificGroupDiscount
