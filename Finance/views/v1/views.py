        ...
        try:
            ...
            if serializer.is_valid():
                ...
                try:    
                    ...
                    return Response({'Previous checkout Instance': AppointmentCheckout(checkout_instance.appointment), 'New Checkout Instance': AppointmentCheckout(newCheckoutInstance.appointment)})
