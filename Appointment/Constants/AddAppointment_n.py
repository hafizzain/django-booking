        ...
        try:
            ...
            for appo in appointment:
                ...
                if staff_email.sms_daily_sale == True:
                    try:   
                        html_file = render_to_string("AppointmentEmail/Email_notification_on_appointment_n", {'location':loc_name, 'ser_name':ser_name  , 'duration':dur,'time':datetime.today, 'date':dat, 'staff':staff})
