    ...
    with tenant_context(tenant):
        ...
        try:
            ...
            if staff_email.sms_daily_sale == True:                    
                html_file = render_to_string("AppointmentEmail/cancel_appointment.html", {'name': name_c, 'ser_name':ser_name ,'t_name':mem_name , 'date':dat,'time':time ,'mem_id':mem_id})
            ...
            if client_email.sms_appoinment == True:
                html_file = render_to_string("AppointmentEmail/cancel_appointment.html", {'name': name_c, 'ser_name':ser_name ,'t_name':name_c , 'date':dat,'time':time, 'mem_id':mem_id})
                text_content = strip_tags(html_file)
