...
class AllAppoinmentSerializer(serializers.ModelSerializer):
    ...
    def get_appointment_status(self, obj):
        if obj.appointment_status == 'Appointment_Booked' or  obj.appointment_status == 'Appointment_Booked' ==  'Arrived' or obj.appointment_status == 'Appointment_Booked' == 'In Progress' :
            return 'Upcomming'
