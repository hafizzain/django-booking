...
def StaffSaleEmail(ids = None, location = None, tenant = None, member =None, invoice = None, item = None, quantity = None, client = None,staff = None):
    time = datetime.today()
    ...
    with tenant_context(tenant):
        ...
        try:   
            html_file = render_to_string("Sales/email_notification_on_daily_booking.html", {'invoice': invoice,'item': item,'quantity':quantity,'date': date,'time': current_time, 'staff': staff})
