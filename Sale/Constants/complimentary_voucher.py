...
def StaffSaleEmail(ids = None, location = None, tenant = None, member =None,service=None, invoice = None,discount_percentage=None,discount_duration=None, client = None,duration_left=None):
    time = datetime.today()
    ...
    with tenant_context(tenant):
        ...
        try:   
            html_file = render_to_string("Sales/complimentary_vouchers_n.html", {'id':ids,'service': service,'disc_p':discount_percentage,'disc_d':discount_duration,'dur_l':duration_left})
