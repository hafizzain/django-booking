...
urlpatterns = [
    ...
    path('get_service_main_page/',views.get_service_main_page),
    path('get_service_optimized/',views.get_service_optimized),
    ...
    path('get_servicegroup_main_page/', views.get_servicegroup_main_page),
